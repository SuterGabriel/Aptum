...
class VerordnungsGueltigkeitTest {
    ...
    private Pruefergebnis physio(int einheiten, LocalDate stichtag) {
        return regel.pruefe(
                Verlauf.verordnung(Therapieform.PHYSIOTHERAPIE, einheiten),
    ...
    void bezugspunktIstDieErsteBehandlung() {
        ...
        assertTrue(ergebnis.begruendung().contains(Verlauf.ERSTER_TAG.toString()),
    ...
    void ergotherapieHatKeineBelegteLaufzeit() {
        ...
        assertTrue(ergebnis.istErfuellt(),
                "eine unsichere Quelle wird nicht zur erfundenen Frist");
        assertTrue(ergebnis.begruendung().contains("Ergotherapie"),
