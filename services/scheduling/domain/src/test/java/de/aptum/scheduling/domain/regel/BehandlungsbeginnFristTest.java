...
class BehandlungsbeginnFristTest {
    ...
    void dieselbeVerordnungMitUndOhneKennzeichen() {
        long tage = 20;
        assertTrue(pruefeNach(tage, false).istErfuellt(),
                "ohne Kennzeichen liegt Tag 20 innerhalb der Regelfrist");
        assertEquals(Pruefergebnis.Ausgang.VERLETZT, pruefeNach(tage, true).ausgang(),
    ...
    void beginnVorAusstellung() {
        ...
        assertTrue(ergebnis.begruendung().contains("vor dem Ausstellungsdatum"),
