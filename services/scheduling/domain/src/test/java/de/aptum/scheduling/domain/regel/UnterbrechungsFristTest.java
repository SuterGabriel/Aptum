...
class UnterbrechungsFristTest {
    ...
    void ohneKennzeichen(long abstand, Pruefergebnis.Ausgang erwartet, String situation) {
        assertEquals(erwartet,
                pruefe(Therapieform.PHYSIOTHERAPIE, Verlauf.mitAbstaenden(abstand)).ausgang(),
                situation);
    }
    ...
    void mitKennzeichen(Unterbrechungskennzeichen kennzeichen) {
        ...
        assertTrue(pruefe(Therapieform.PHYSIOTHERAPIE, verlauf).istErfuellt(),
                "60 Tage sind mit Begruendung zulaessig");
    }
    ...
    void kennzeichenUNurBeiErgo() {
        ...
        assertTrue(pruefe(Therapieform.ERGOTHERAPIE, verlauf).istErfuellt(),
    ...
    void einzelnerTermin() {
        ...
        assertTrue(pruefe(Therapieform.PHYSIOTHERAPIE, Behandlungsverlauf.leer()).istErfuellt());
    }
    ...
    void luckeInDerMitte() {
        ...
        assertTrue(ergebnis.begruendung().contains("40"),
                "die Begruendung nennt die Luecke, die es war");
    }
}
