...
| SA6 | Entwicklung von Java-Backends und REST-APIs | belegt | REST in `services/scheduling/infrastructure/src/main/java/de/aptum/scheduling/infrastructure/rest/` — vier Controller, Suchen, Prüfen, Buchen, Verordnung anlegen und ansehen, Woche, Abrechnung; 404 für fremde wie für unbekannte Kennungen; OpenAPI erzeugt und gegen die laufende Anwendung geprüft: `docs/api/openapi.json` |
