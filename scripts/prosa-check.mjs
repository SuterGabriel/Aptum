...
const AUSNAHMEN = new Map([
  // Das Glossar definiert diesen Bezeichner ausdrücklich in ASCII, weil er so
  // im Java-Code steht. Er taucht deshalb auch in Fließtext auf.
  ['pruefergebnis', 'Bezeichner laut .claude/skills/heilmittel-domain/glossar.md'],
  ['pruefergebnisse', 'Mehrzahl desselben Bezeichners'],
  ['pruefe', 'Funktionsname in beleg-check.sh und Methodenname im Domänenmodell'],
]);
